package classes.core
{
	...
	import classes.event.MediaMaskEvent;
	import classes.graphics.ColorStyleEnum;
	import classes.mediaItem.MediaShapMask;
	 ...
	 * 被选中之前触发
	 */	
	[Event(name="beforSelect", type="classes.event.MediaItemEvent")]

	/**
	 * 被选后时触发
	 */	
	[Event(name="onSelected", type="classes.event.MediaItemEvent")]

	/**
	 * 被遮罩后触发
	 */	
	[Event(name="onMasked", type="classes.event.MediaMaskEvent")]
