...
package org.puremvc.as3.interfaces
{
	...
	public interface IController
	{
		...
		/**
		 *do last wheather the command implements IUndoCommand interface and registered in facade
		 */
		function undoLastCommand(  ) : void;

		/**
		 *do previous wheather the command implements IUndoCommand interface and registered in facade
		 */
		function redoPreviousCommand( ) : void

		/**
		 * has undoLastCommand?
		 */
		function get hasLastCommand(  ) : Boolean;

		/**
		 * has redoLastCommand?
		 */
		function get hasRedoCommand(  ) : Boolean;
	}
}