...
{
	import classes.contextmenu.ContextMenuLabels;
	import classes.contextmenu.ContextMenuPlus;
	import classes.event.MediaContainerEvent;
	import classes.event.MediaItemEvent;
	import classes.mediaItem.MediaImage;
	import classes.mediaItem.MediaShape;
	 ...
	 * 当有东西被拖近来时触发
	 */
	[Event(name="onAddChild", type="classes.event.MediaContainerEvent")]

	/**
	 * 当拖近来的东西被选中时触发
	 */
	[Event(name="onSelect", type="classes.event.MediaItemEvent")]
